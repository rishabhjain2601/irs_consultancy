    ...
    return (
        <div className="overflow-hidden">
            ...
            <div className="top-0 align-middle my-[6rem]">
                <h1 className="text-4xl font-bold text-center font-sans md:mt-[6rem] mt-32 mx-auto">Our Ways Of Working</h1>
                <div className="md:flex mt-6 md:relative md:bottom-[18%] md:justify-center mx-auto w-[95%]">
                    ...
                    At IRS, our primary goal is to streamline the hiring process for our clients, aiming to fill any shared position <b>within 2 weeks</b>. To achieve this, we offer <b>customized plans</b> that cater to the unique needs of each client.
                        <br />
                        <br />
                        <ol type="1" className="list-decimal text-lg">
                            ...
                            <u className='font-semibold'>Benefits</u> – No technical round required at client’s end hence technical panel at client’s end are not required.
<br />
<br />
                            ...
                            <u className='font-semibold'>Benefits</u> – Technically superior profiles would be shared as candidates would have already undergone a technical test already. This would help in early closure of position.
                            <br />
<br />
                            <li><b>Sourcing of profiles</b> – In this plan, we screen the suitable candidates as per requirements shared and share the same with the client. Basis on shortlisting, we line them for further rounds to be conducted at client’s end.</li>
                                ...
                                <u className='font-semibold'>Benefits</u> – Client would be able to assess the candidates via their own technical panel but the overall time in closing a position would be more in comparison to above two mentioned plans.
                        </ol>
                    </p>
                </div>
            </div>
