    ...
    return (
        <div class="overflow-hidden">
            ...
            <div class="top-0 align-middle my-[6rem]">
                <h1 class="text-6xl font-bold text-center font-sans md:mt-[6rem] mt-32 mx-auto">Ways Of Working</h1>
                <div class="md:flex mt-6 md:relative md:bottom-[18%] md:justify-center mx-auto w-[95%]">
                    <img src="mission.svg" alt="" class="mx-auto justify-center mt-4 md:w-[40%] my-auto" />
                    <p class='w-[100%] md:float-right my-10 mx-auto px-4 text-lg'>
...
<br />
            ...
            <footer class="bottom-0 w-full relative z-0">
                <Footer />
            </footer>
        </div>
    )
