...
const Navbar = () => {
    ...
    return (
        <div class='md:bg-transparent'>
            <img src="nav.svg" alt="" class="md:hidden w-full top-16 -z-1 relative" />
            ...
            <nav class="md:bg-transparent w-full z-20 top-0 start-0 absolute z-2">
                <div class="max-w-screen-xl md:bg-transparent flex flex-wrap p-4 ">
                    ...
                    <img src="irslogo.png" class="h-[40px] ml-2 cursor-pointer" alt="IRS Logo" onClick={() => { navigate('/') }} />
                    ...
                    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                        <ul class="flex flex-col md:absolute md:right-0 md:mr-10 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:bg-transparent bg-white md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <button type="button" onClick={() => { navigate('/contact_us') }} class={`${location.pathname === "/contact_us" ? 'md:text-blue-700 md:bg-white md:hover:bg-blue-700 md:hover:text-white border-blue-700 md:border' : ''} text-white bg-blue-700 hover:bg-blue-800 cursor-pointer focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-1.5 text-center`} >Contact Us</button>
                        </ul>
                    </div>
                </div>
            </nav>
